...
from api_tools import preprocess_midi, undo_transpose, GenerationError, InvalidNoteDurationError
import time
...
def handle_local_submission(midi_path: str, output_path: str, temperature: float,
    ...
    # Parse file
    try:
        supplied_seed, reverse_transposition = preprocess_midi(midi_path=midi_path, verbose=True)
